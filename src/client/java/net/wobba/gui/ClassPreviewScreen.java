...
public class ClassPreviewScreen extends AbstractContainerScreen<ClassPreviewMenu> {

    private static final Identifier CHEST_TEXTURE =
            Identifier.withDefaultNamespace("textures/gui/container/generic_54.png");

    public ClassPreviewScreen(ClassPreviewMenu menu, Inventory inventory, Component title) {
